...
As the company grew, data became increasingly important — and increasingly unreliable.  
Metrics were unclear, data sources were fragmented, and numbers could not be trusted.

That was when I transitioned into a **Data Engineer**.

I became the first data engineer in the team and built the data system from zero:
- discovering existing data sources,
- cleaning and validating messy data,
- designing data pipelines and models,
- and enabling teams to make decisions based on trustworthy metrics.
